namespace Team3_ProjectB
{
    public class ShowMovies
    {
        ...
        public static void DisplaySessions()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("Use ↑ ↓ to choose a movie, press Enter to select or Backspace to return to menu:\n");
                ...
                if (key == ConsoleKey.UpArrow && selectedIndex > 0)
                    ...
                    return; // Keer terug naar menu-loop
